...
class VxRailAuthAutomator:
    ...
    def prepare_network_info_and_payload(self, hosts_spec_len, is_subnet_found):
        ...
        network_payload = [
            self.to_network_obj('VSAN', vsan_vlan_id, vsan_cidr, vsan_subnet, vsan_gateway, vsan_ip_range),
            self.to_network_obj('VMOTION', vmotion_vlan_id, vmotion_cidr, vmotion_subnet, vmotion_gateway,
                                vmotion_ip_range)]
